...
This directory contains user-facing installation, deployment, operation, and integration guides. Repository-internal engineering rules remain in [`.project/`](../.project/).
